...
export class DefaultInterceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    const headers = {
      ...
      'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlX2lkIjoiNWZhNGVlMGYwZDYwZTgwNzEwNTU2ODE1IiwidXNlcl90eXBlIjoiQURNSU4iLCJ1c2VyX2lkIjoiNWZhNGVlYmYwZDYwZTgwNzEwNTU2ODE2IiwiY3VzdG9tZXJfaWQiOm51bGwsInNlc3Npb25JZCI6IndkSDRqWG9iWWxlSFhra3N2T2szdkFOcGdhVlp0NVZtIiwiaWF0IjoxNjA0NjQ0NjA4fQ.nDaSHnVeFyE9EAZGcmi48JwaSVWwVOX7-ArbEkCzoQQ'//`Bearer ${this.token.get().token}`,
    };
    let requrl = req.url
